    ...
    describe("part 1") {
        ...
        describe("examples") {
            val testData = arrayOf(
                data("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99", listOf(), listOf(109L, 1L, 204L, -1L, 1001L, 100L, 1L, 100L, 1008L, 100L, 16L, 101L, 1006L, 101L, 0L, 99L)),
                data("1102,34915192,34915192,7,4,7,99,0", listOf<Long>(), listOf(1219070632396864L)),
                data("104,1125899906842624,99", listOf(), listOf(1125899906842624L))
            )
